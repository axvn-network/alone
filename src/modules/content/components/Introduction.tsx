      ...
      <div className="relative max-w-[1400px] mx-auto section-px">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <Stagger>
            ...
            <StaggerItem>
              <h2
                className="text-AXVN-ivory font-light leading-[1.28] uppercase mt-5"
            ...
            <StaggerItem>
              <motion.div variants={goldenDivider} initial="hidden" whileInView="visible" viewport={{ once: true }} className="h-px w-10 bg-AXVN-gold/40 my-7" />
            </StaggerItem>
            <StaggerItem>
              <p className="text-AXVN-silver/85 leading-[1.8] mb-5" style={{ fontSize: "var(--text-body)" }}>
                {introParagraph1}
              </p>
            </StaggerItem>
            <StaggerItem>
            ...
            <StaggerItem>
              <p className="text-AXVN-silver/70 leading-[1.8]" style={{ fontSize: "var(--text-body)" }}>
                {introParagraph3}
              </p>
            </StaggerItem>
          </Stagger>
          ...
          >
            <motion.div
              className="relative aspect-[3/4] sm:aspect-[4/5] w-full overflow-hidden rounded-sm border border-AXVN-gold/10"
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-AXVN-navy/20" />
              <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-AXVN-gold/60" />
              <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-AXVN-gold/60" />
            </motion.div>
          </motion.div>
        </div>
      </div>
