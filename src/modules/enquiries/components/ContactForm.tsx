...
export default function ContactForm() {
  ...
  const inputCls =
    "w-full px-4 md:px-5 py-3 md:py-3.5 bg-white border border-AXVN-navy/15 text-AXVN-navy placeholder:text-AXVN-navy/25 focus:outline-none focus-visible:outline-none focus:border-AXVN-gold/60 focus:ring-1 focus:ring-AXVN-gold/20 transition-colors";
  const labelCls =
    "block text-AXVN-navy/55 text-[11px] font-semibold uppercase tracking-[0.18em] mb-2";
