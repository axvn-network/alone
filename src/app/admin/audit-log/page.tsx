...
const COLLECTIONS = [
  ...
  "investment_plans", "settings", "admins",
];
...
export default function AuditLogPage() {
  ...
  useEffect(() => {
    setPage(1);
    fetchLogs(1);
  }, [action, actorId, collection, from, to, fetchLogs]);
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gvi-silver/50 text-xs">{total.toLocaleString("vi-VN")} bản ghi · tự xóa sau 90 ngày</p>
              </div>
            </div>
            <button
