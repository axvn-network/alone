...
export const metadata: Metadata = {
  ...
  description:
    "Lộ trình chiến lược tương tác GVI Tech Holding giai đoạn 2026–2031: timeline trực quan, KPI tổng quan và nội dung chi tiết có thể mở rộng.",
};
  ...
  return (
    <main className="min-h-screen bg-white pb-safe md:pb-0">
      <PageHero
        ...
        heading="Lộ Trình Tổng Thể GVI Tech Holding"
