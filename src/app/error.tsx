    ...
    <main className="min-h-screen bg-gvi-navy">
      <section className="pt-32 pb-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          <p className="text-gvi-gold text-sm font-medium tracking-[4px] uppercase mb-4">500</p>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Unexpected Error</h1>
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-8 py-3 border border-gvi-gold text-gvi-gold font-bold text-sm tracking-widest hover:bg-gvi-gold/10 transition-all duration-300 rounded-sm"
            >
              Back to Home
            </Link>
          </div>
