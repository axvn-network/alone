                ...
                {!stats || stats.activities.length === 0 ? (
                  ...
                  stats.activities.slice(0, 6).map((a) => (
                    <div key={a.id} className="flex items-center gap-4 px-6 py-4 hover:bg-white/2 transition-colors group">
                      {/* icon */}
                      <div className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 ${a.type === "contact"
                          ? "bg-emerald-500/10 border border-emerald-500/20"
                          : "bg-AXVN-gold/10 border border-AXVN-gold/20"
                        }`}>
                        {a.type === "contact"
                      ...
                      <div className="flex flex-col items-end gap-1 shrink-0">
                        <span className={`text-[10px] px-2 py-0.5 rounded-full font-semibold uppercase tracking-wider ${a.type === "contact"
                            ? "bg-emerald-500/10 text-emerald-400"
                            : "bg-AXVN-gold/10 text-AXVN-gold"
                          }`}>
