        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 relative z-10 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link
                href="/admin/blog/new"
                className="flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-AXVN-gold text-AXVN-navy text-sm font-bold hover:bg-AXVN-champagne transition-all rounded-lg shadow-lg shadow-AXVN-gold/10"
              >
            ...
            <div className="px-5 py-4 border-b border-white/5 flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <div className="relative flex-1 max-w-sm">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-white/5 border border-white/10 text-AXVN-ivory text-sm rounded-lg placeholder:text-AXVN-silver/30 focus:outline-none focus:border-AXVN-gold/40 transition-colors"
                />
              </div>
