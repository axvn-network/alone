...
export default function InvestWithFortressPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* For Investors */}
      <section className="py-12 md:py-20 bg-fortress-navy my-8 md:my-12 mx-2 sm:mx-4 rounded-2xl" id="invest">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
      ...
      <section className="py-12 md:py-20 my-8 md:my-12 mx-2 sm:mx-4 rounded-2xl bg-white" id="sectors">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
      ...
      <section className="py-12 md:py-20 bg-fortress-deep my-8 md:my-12 mx-2 sm:mx-4 rounded-2xl" id="model">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
      ...
      {/* Form Section */}
      <section className="py-12 md:py-20 bg-white my-8 md:my-12 mx-2 sm:mx-4 rounded-2xl" id="enquiry">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
