...
export default function PartnershipCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 bg-gradient-to-b from-AXVN-navy/95 via-AXVN-navy/90 to-AXVN-navy/95" />
      ...
      <div className="relative z-20 max-w-[1400px] mx-auto section-px">
        <div className="max-w-[900px] mx-auto text-center">
          <Stagger>
            ...
            <StaggerItem>
              <h2
                className="text-AXVN-ivory font-light mb-7 uppercase leading-[1.28]"
            ...
            <StaggerItem>
              <p
                className="text-AXVN-silver/88 leading-[1.8] mb-5 max-w-[660px] mx-auto"
            ...
            <StaggerItem>
              <p
                className="text-AXVN-silver/65 leading-[1.8] mb-10 md:mb-14 max-w-[580px] mx-auto"
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center">
                ...
                >
                  <Link
                    ...
                    className="block px-9 py-4 bg-gradient-to-r from-AXVN-gold to-AXVN-champagne text-AXVN-navy font-bold text-xs uppercase shadow-lg shadow-AXVN-gold/15 hover:opacity-90 transition-opacity"
                ...
                >
                  <Link
                    href="/contact"
                    className="block px-9 py-4 border border-AXVN-gold/70 text-AXVN-gold text-xs uppercase font-semibold hover:bg-AXVN-gold/8 hover:border-AXVN-gold transition-all duration-300"
                    style={{ letterSpacing: "var(--tracking-btn)" }}
                  >
                    {ctaBtn2Text}
                  </Link>
