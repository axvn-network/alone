...
import RoleAssessmentQuiz, { type QuizResult } from "@/app/(site)/components/public/RoleAssessmentQuiz";
...
export default function PartnerApplicationFlow() {
    ...
    return (
      <div className="text-center py-16">
        ...
        <p className="text-AXVN-silver/75 max-w-md mx-auto text-sm leading-relaxed">
          Đội ngũ AXVN Tech Holding sẽ xem xét đơn và phản hồi trong vòng <strong className="text-AXVN-ivory">2–5 ngày làm việc</strong>.
          Chúng tôi sẽ liên hệ qua email <span className="text-AXVN-gold">{form.email}</span>.
        </p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-7">
        ...
        <div className="flex items-center gap-3 p-4 bg-AXVN-gold/6 border border-AXVN-gold/25 rounded-xl">
          ...
          <div>
            <p className="text-AXVN-ivory text-sm font-semibold">
              Vai trò được đề xuất: <span className="text-AXVN-gold">{ROLE_LABELS[quizResult.suggestedRole]}</span>
            </p>
            <p className="text-AXVN-silver/60 text-xs mt-0.5">Bạn có thể thay đổi bên dưới nếu muốn.</p>
          </div>
        </div>
      )}
      ...
      {/* Thông tin cá nhân */}
      <div>
        <p className="text-AXVN-silver/70 text-xs uppercase tracking-widest mb-4 font-semibold">Thông Tin Liên Hệ</p>
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-AXVN-silver text-xs mb-1.5">Họ và tên *</label>
            <input
          ...
          <div>
            <label className="block text-AXVN-silver text-xs mb-1.5">Số điện thoại</label>
            <input
        ...
        <div className="mt-4">
          <label className="block text-AXVN-silver text-xs mb-1.5">Email *</label>
          <input
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-4">
          <div>
            <label className="block text-AXVN-silver text-xs mb-1.5">Công ty / Tổ chức</label>
            <input
          ...
          <div>
            <label className="block text-AXVN-silver text-xs mb-1.5">Chức vụ</label>
            <input
        ...
        <div className="mt-4">
          <label className="block text-AXVN-silver text-xs mb-1.5">LinkedIn (nếu có)</label>
          <input
      ...
      {/* Vai trò & Vốn */}
      <div>
        <p className="text-AXVN-silver/70 text-xs uppercase tracking-widest mb-4 font-semibold">Vai Trò & Cam Kết Vốn</p>
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-AXVN-silver text-xs mb-1.5">Vai trò mong muốn *</label>
          ...
          <div>
            <label className="block text-AXVN-silver text-xs mb-1.5">Quy mô vốn dự kiến</label>
            <div className="relative">
              <select
        ...
        <div className="mt-4">
          <label className="block text-AXVN-silver text-xs mb-1.5">Hạng mục hợp tác quan tâm</label>
          <div className="relative">
            <select
          ...
          <p className="text-AXVN-silver/40 text-xs mt-1">
            Xem chi tiết:{" "}
            <a href="/invest-with-axvn/plans" target="_blank" className="text-AXVN-gold/70 underline hover:text-AXVN-gold transition-colors">
      ...
      {/* Lý do & Năng lực */}
      <div>
        <p className="text-AXVN-silver/70 text-xs uppercase tracking-widest mb-4 font-semibold">Năng Lực & Động Cơ</p>
      ...
      <div>
        <label className="flex items-start gap-3 cursor-pointer group">
          ...
          <span className="text-AXVN-silver/70 text-xs leading-relaxed group-hover:text-AXVN-silver transition-colors">
            Tôi đồng ý cho AXVN Tech Holding xử lý thông tin cá nhân của tôi để xem xét đơn đăng ký này,
            theo đúng quy định tại{" "}
            <a href="/privacy-policy" target="_blank" className="text-AXVN-gold/80 underline hover:text-AXVN-gold">
