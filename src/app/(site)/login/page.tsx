      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            <span className="text-AXVN-gold text-xs font-semibold tracking-widest uppercase">Đăng Nhập Tài Khoản</span>
          </div>
        </div>

        {/* Card */}
        <div className="bg-[#06101a] border border-AXVN-gold/15 rounded-2xl p-8 shadow-2xl">
          <h1 className="text-AXVN-ivory font-semibold text-xl mb-1">Chào mừng trở lại</h1>
          <p className="text-AXVN-silver/50 text-sm mb-7">
            Chưa có tài khoản?{" "}
            <Link href="/register" className="text-AXVN-gold hover:text-AXVN-champagne transition-colors font-medium">
              Đăng ký ngay
            </Link>
          </p>
          ...
          <p className="text-AXVN-silver/30 text-xs text-center mt-6 leading-relaxed">
            Tài khoản cổ đông?{" "}
            <Link href="/portals/shareholders/login" className="text-AXVN-gold/60 hover:text-AXVN-gold transition-colors">
              Vào cổng cổ đông
            </Link>
          </p>
        </div>
