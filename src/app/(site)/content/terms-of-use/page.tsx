...
export const metadata: Metadata = {
  ...
  description:
    "Điều khoản sử dụng website AXVN Tech Holding. Vui lòng đọc kỹ các điều khoản trước khi truy cập dịch vụ.",
};
  ...
  return (
    <main className="min-h-screen bg-white pb-safe md:pb-0">
      <PageHero
        ...
        description="Khi truy cập hoặc sử dụng website AXVN Tech Holding, bạn đồng ý tuân thủ các điều khoản dưới đây. Nếu không đồng ý, vui lòng tạm dừng sử dụng website."
      />
