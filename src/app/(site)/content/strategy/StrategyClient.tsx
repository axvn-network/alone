...
import KpiDashboard from "@/components/visual/KpiDashboard";
...
const KPI_ITEMS = [
  ...
  },
  {
    value: 4,
    label: "mảng năng lực",
    description: "Mô hình điều phối định hướng của GVI Group.",
    icon: Building2,
  },
  {
    value: 5,
    ...
    <DocLayout>
      ...
      <DocMain>
        <section id="kpi" aria-labelledby="kpi-heading" className="mb-12">
          <h2 id="kpi-heading" className="text-[10px] font-semibold uppercase tracking-widest text-gvi-gold mb-4">
            Tổng Quan
          </h2>
