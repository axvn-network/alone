...
import ProseDoc, { ProseNote } from "@/app/(site)/components/public/ProseSection";
        ...
        <div className="max-w-[860px] mx-auto section-px">
          ...
          <div className="mb-10 md:mb-14 p-5 md:p-6 border border-amber-400/30 bg-amber-50/60 rounded-sm flex gap-4 items-start">
            ...
            <p className="text-amber-800/80 text-sm leading-relaxed">
              ...
              Không có bất kỳ cam kết bảo đảm lợi nhuận nào từ phía AXVN Tech Holding.
            </p>
          </div>
            ...
            sections={[
              {
                ...
                content: (
                  <>
                    <p>
                      Tất cả các hình thức đầu tư đều tiềm ẩn rủi ro. Giá trị các khoản đầu tư —
                      bao gồm bất động sản, công ty tư nhân, tài sản số — có thể tăng hoặc giảm.
                      Nhà đầu tư có thể mất một phần hoặc toàn bộ số vốn đã giải ngân.
                    </p>
                    <ProseNote>
              ...
              },
              {
                ...
                content: (
                  <p>
                    Các khoản đầu tư vào doanh nghiệp tư nhân, thâu tóm M&amp;A hay bất động sản thường có tính
                    thanh khoản thấp. Nhà đầu tư có thể không rút vốn được trong thời gian ngắn hoặc gặp khó khăn
                    khi thoái vốn theo mong muốn.
                  </p>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p>
                      Các khoản đầu tư liên quan đến tài sản số có thể chịu biến động giá mạnh, bất ổn pháp lý,
                      rủi ro an ninh mạng, rủi ro công nghệ, rủi ro thanh khoản, rủi ro lưu ký và khả năng mất toàn bộ vốn.
                    </p>
                    <ProseNote>
                      Việc đề cập đến blockchain hoặc tài sản số trên website này không được hiểu là khuyến nghị
                      mua, bán hay nắm giữ bất kỳ tài sản số nào.
                    </ProseNote>
                  </>
                ),
              },
              {
                ...
                content: (
                  <p>
                    Bất kỳ cá nhân hay tổ chức nào cân nhắc đầu tư, mua lại, hợp tác hay giao dịch đều nên
                    tự thực hiện thẩm định độc lập và tham khảo ý kiến từ các chuyên gia tài chính, pháp lý,
                    thuế và kế toán có chuyên môn phù hợp trước khi ra quyết định.
                  </p>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p>
                      AXVN Tech Holding không bảo đảm lợi nhuận đầu tư, bảo vệ vốn, thu nhập,
                      khả năng sinh lợi, tăng giá trị tài sản, hoàn thành thành công bất kỳ giao dịch nào,
                      hay khả năng thoái vốn theo kỳ vọng.
                    </p>
                    <p className="mt-3">
                      Mọi dự báo, kế hoạch, mục tiêu hay kỳ vọng đều chịu ảnh hưởng của sự không chắc chắn
                      và có thể không đạt được.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <p>
                    ...
                    AXVN Tech Holding cung cấp các dịch vụ tài chính được quản lý, trừ khi
