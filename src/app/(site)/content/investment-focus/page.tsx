...
export default function InvestmentFocusPage() {
  return (
    <main className="min-h-screen bg-white pb-safe md:pb-0">
      ...
      {/* Introduction */}
      <section className="bg-AXVN-navy rounded-2xl section-mx section-my" style={{ paddingTop: "var(--section-py)", paddingBottom: "var(--section-py)" }}>
        <div className="max-w-[1400px] mx-auto section-px">
          <div className="max-w-3xl">
            ...
            <p className="text-AXVN-silver/80 leading-[1.8] mb-4" style={{ fontSize: "var(--text-body)" }}>
            ...
            <p className="text-AXVN-silver/70 leading-[1.8] mb-4" style={{ fontSize: "var(--text-body)" }}>
              AXVN Tech Holding định vị tập trung vào FinTech, dịch vụ tài sản mã hóa, blockchain, EdTech và kinh tế số — những lĩnh vực đang hội tụ để tạo ra hệ sinh thái tài chính số hoàn toàn mới tại Việt Nam.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="mt-6 md:mt-8">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                    {sector.items.map((item, i) => (
                      <li key={i}>
                        {typeof item === "string" ? (
                          <div className={`flex items-start gap-3 p-3 border-l-2 border-AXVN-gold/30 ${index % 2 === 1 ? "bg-AXVN-navy/60" : "bg-AXVN-ivory/40"} rounded-sm`}>
                            <span className="mt-1 text-AXVN-gold text-[10px] font-mono font-bold shrink-0 select-none">
                              {String(i + 1).padStart(2, "0")}
                            </span>
                            <span className={`text-xs md:text-sm leading-relaxed ${index % 2 === 1 ? "text-AXVN-silver/80" : "text-AXVN-charcoal/60"}`}>
                              {item}
                            </span>
                          </div>
                        ) : (
                          <div className={`p-3 border border-AXVN-gold/15 rounded-sm hover:border-AXVN-gold/30 transition-colors ${index % 2 === 1 ? "bg-AXVN-navy/40" : "bg-AXVN-ivory/30"}`}>
                            <p className={`text-sm font-semibold mb-0.5 ${index % 2 === 1 ? "text-AXVN-ivory" : "text-AXVN-navy"}`}>
                              {item.heading}
                            </p>
                            <p className={`text-xs leading-relaxed ${index % 2 === 1 ? "text-AXVN-silver/70" : "text-AXVN-charcoal/60"}`}>
                              {item.desc}
                            </p>
                          </div>
                        )}
      ...
      <section className="bg-AXVN-navy rounded-2xl section-mx section-my" style={{ paddingTop: "var(--section-py)", paddingBottom: "var(--section-py)" }}>
        <div className="max-w-[1400px] mx-auto section-px text-center">
          ...
          <p className="text-AXVN-silver/80 leading-[1.8] max-w-2xl mx-auto mb-8" style={{ fontSize: "var(--text-lead)" }}>
            Nếu bạn làm việc trong FinTech, tài sản mã hóa, AI hoặc kinh tế số — và bạn tin vào những gì AXVN Tech Holding đang xây dựng — chúng tôi muốn nói chuyện. Không phải về vốn, mà về việc cùng nhau tạo ra điều gì đó có ý nghĩa lâu dài.
          </p>
          <Link
