...
export const metadata: Metadata = {
  ...
  description:
    "Khám phá các lĩnh vực đầu tư chiến lược của GVI Tech Holding: Dịch vụ tài sản mã hóa hợp pháp, FinTech, Công nghệ AI, EdTech, Blockchain và Kinh tế số — phù hợp với Nghị quyết 5/2025/NQ-CP có hiệu lực từ 9/9/2025.",
  openGraph: {
    title: "Lĩnh Vực Đầu Tư | GVI Tech Holding",
    description:
...
const sectors = [
  {
    ...
    disclaimer:
      "GVI Tech Holding không khuyến khích đầu cơ ngắn hạn. Mọi hoạt động đầu tư liên quan đến tài sản mã hóa phải tuân thủ quy định pháp luật hiện hành.",
    closing:
      "Đây là thời điểm vàng để định vị sớm trong thị trường tài sản mã hóa hợp pháp đầu tiên của Việt Nam. GVI Tech Holding đồng hành cùng doanh nghiệp và nhà đầu tư tận dụng cửa sổ pháp lý lịch sử 5 năm này — với sự thận trọng, tuân thủ và tầm nhìn dài hạn.",
  },
  {
    id: "fintech-payments",
    icon: TrendingUp,
    ...
    image: "/3.png",
    body: "Việt Nam có trên 78 triệu người dùng internet, tỷ lệ thanh toán số tăng trưởng mạnh mẽ và thị trường tài chính với hàng triệu người chưa được phục vụ đầy đủ — tạo ra nền tảng lý tưởng cho FinTech.\n\nGVI Tech Holding đầu tư vào các doanh nghiệp FinTech xây dựng hạ tầng tài chính số thiết thực, giải quyết nhu cầu thực của thị trường Việt Nam và tích hợp tự nhiên vào hệ sinh thái tài sản mã hóa đang hình thành.",
    items: [
  ...
  },
  {
    ...
    image: "/6.png",
    body: "Công nghệ AI là một trong các trọng tâm đầu tư hàng đầu của GVI Tech Holding. Việt Nam — với hơn 78 triệu người dùng internet, tốc độ tăng trưởng thương mại điện tử hàng đầu Đông Nam Á và hệ sinh thái startup công nghệ năng động — là thị trường chiến lược mà chúng tôi cam kết đầu tư dài hạn.\n\nChúng tôi không chạy theo xu hướng. Chúng tôi đầu tư vào các doanh nghiệp công nghệ giải quyết vấn đề thực tiễn, có mô hình doanh thu rõ ràng và đội ngũ sáng lập đủ năng lực để mở rộng quy mô.",
    items: [
  ...
  },
  {
    ...
    image: "/5.png",
    body: "Sự phát triển của thị trường tài sản mã hóa hợp pháp tại Việt Nam đòi hỏi hạ tầng blockchain vững chắc, an toàn và có khả năng mở rộng.\n\nGVI Tech Holding đầu tư vào các công ty xây dựng hạ tầng kỹ thuật thiết yếu — từ mạng lưới blockchain cấp doanh nghiệp đến các giao thức bảo mật, hợp đồng thông minh và giải pháp tương tác liên chuỗi — tạo nền tảng cho hệ sinh thái tài sản mã hóa Việt Nam.",
    items: [
  ...
  },
  {
    ...
    image: "/7.png",
    body: "Kinh tế số Việt Nam đang tăng trưởng với tốc độ hàng đầu Đông Nam Á — thương mại điện tử, nội dung số, dịch vụ trực tuyến và hạ tầng logistics số tất cả đều đang trong giai đoạn mở rộng mạnh mẽ.\n\nGVI Tech Holding đầu tư vào các doanh nghiệp xây dựng hạ tầng nền tảng và mô hình kinh doanh bền vững trong kinh tế số — những doanh nghiệp tạo ra giá trị thực và có lộ trình tích hợp với hệ sinh thái tài sản số đang hình thành.",
    items: [
  ...
  return (
    <main className="min-h-screen bg-white pb-safe md:pb-0">
      ...
      <PageHero
        ...
        description="GVI Tech Holding đặt FinTech, tài sản mã hóa hợp pháp và kinh tế số Việt Nam là trọng tâm chiến lược — tiên phong đón đầu Nghị quyết 5/2025/NQ-CP có hiệu lực từ 9/9/2025."
      />
        ...
        <div className="max-w-[1400px] mx-auto section-px">
          <div className="max-w-3xl">
            ...
            <p className="text-gvi-silver/70 leading-[1.8] mb-4" style={{ fontSize: "var(--text-body)" }}>
              GVI Tech Holding định vị tập trung vào FinTech, dịch vụ tài sản mã hóa, blockchain, EdTech và kinh tế số — những lĩnh vực đang hội tụ để tạo ra hệ sinh thái tài chính số hoàn toàn mới tại Việt Nam.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gvi-navy rounded-2xl section-mx section-my" style={{ paddingTop: "var(--section-py)", paddingBottom: "var(--section-py)" }}>
        <div className="max-w-[1400px] mx-auto section-px text-center">
          ...
          <p className="text-gvi-silver/80 leading-[1.8] max-w-2xl mx-auto mb-8" style={{ fontSize: "var(--text-lead)" }}>
            Nếu bạn làm việc trong FinTech, tài sản mã hóa, AI hoặc kinh tế số — và bạn tin vào những gì GVI Tech Holding đang xây dựng — chúng tôi muốn nói chuyện. Không phải về vốn, mà về việc cùng nhau tạo ra điều gì đó có ý nghĩa lâu dài.
          </p>
          <Link
