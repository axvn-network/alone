      ...
      <motion.section {...fadeUp} className="bg-[#07111D] section-mx section-my overflow-hidden relative rounded-2xl" style={{ paddingTop: "var(--section-py)", paddingBottom: "var(--section-py)" }}>
        ...
        <div className="relative max-w-[900px] mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/invest-with-gvi" className="px-8 py-4 bg-[#C9A24A] hover:bg-[#E6C879] text-[#07111D] font-bold text-sm transition-all shadow-xl hover:-translate-y-0.5 rounded-lg">Tìm Hiểu Hành Trình</Link>
