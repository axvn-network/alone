...
const SHAREHOLDER_ROLES = ["tech", "financial", "tech-company", "individual", "legal", "foreign"] as const;
const APPLICATION_STATUSES = ["draft", "submitted", "under_review", "shortlisted", "approved", "rejected"] as const;
