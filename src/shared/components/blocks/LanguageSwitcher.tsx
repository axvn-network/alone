        ...
        >
          ...
          <span
            className={`absolute inset-y-[2px] w-[25px] rounded-full shadow-sm transition-all duration-300 z-10 ${
              isVI ? "left-[2px] bg-AXVN-gold" : "left-[27px] bg-white/80"
            }`}
          />
          {/* Chữ VI — ô trái */}
          <span
            className={`relative z-20 flex items-center justify-center text-[9px] font-bold tracking-wide transition-colors duration-200 ${isVI ? "text-AXVN-navy" : "text-white/35"}`}
          >
            VI
          </span>
          {/* Chữ EN — ô phải */}
