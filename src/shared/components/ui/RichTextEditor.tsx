...
export default function RichTextEditor({
  ...
  return (
    <div className="border border-white/10 rounded-lg overflow-hidden">
      <div className="flex items-center gap-0.5 p-1.5 bg-AXVN-deep border-b border-white/10 flex-wrap">
        {tools.map((t) => (
          <button
            key={t.cmd + (t.value || "")}
            type="button"
      ...
      <div
        ...
        className="min-h-[300px] p-4 bg-AXVN-charcoal text-AXVN-ivory text-sm focus:outline-none prose prose-invert max-w-none"
        onInput={handleInput}
      />
    </div>
  );
