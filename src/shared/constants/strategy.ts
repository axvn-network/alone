...
import { ROADMAP_PHASES, type RoadmapPhase } from "@/shared/constants/roadmap";

export type StrategyValueId =
  "sovereignty" | "compliance" | "transparency" | "innovation" | "inclusion";
...
export const CORE_VALUES: readonly StrategyValue[] = [
  {
    ...
    title: "Chủ Quyền Số",
    description:
      "Củng cố năng lực làm chủ hạ tầng, dữ liệu và sở hữu trí tuệ của hệ sinh thái.",
    icon: Network,
  },
  {
    id: "compliance",
    title: "Tuân Thủ",
    description:
      "Đối chiếu yêu cầu pháp lý áp dụng, an toàn thông tin và thẩm quyền phê duyệt trước triển khai.",
    icon: Scale,
  },
  {
    id: "transparency",
    title: "Minh Bạch",
    description:
      "Công bố thông tin có nguồn, nêu rõ giới hạn và không diễn giải kế hoạch là kết quả đã đạt được.",
    icon: Eye,
  },
  {
    id: "innovation",
    title: "Đổi Mới",
    description:
      "Duy trì nghiên cứu, phát triển và thử nghiệm năng lực công nghệ theo nhu cầu thực tiễn.",
    icon: Sparkles,
  },
  {
    id: "inclusion",
    title: "Tiếp Cận Có Trách Nhiệm",
    description:
      "Thiết kế trải nghiệm số có tính bao trùm trong phạm vi phù hợp với điều kiện triển khai.",
    icon: WalletCards,
  },
];
...
export const SUBSIDIARIES: readonly Subsidiary[] = [
  {
    ...
    description:
      "Nghiên cứu năng lực tài chính số và quản trị tài sản số, phụ thuộc đánh giá pháp lý, rủi ro và phê duyệt phù hợp.",
  ...
  },
  {
    ...
    description:
      "Nghiên cứu trải nghiệm thanh toán, thương mại và kết nối đối tác theo các điều kiện triển khai phù hợp.",
  ...
  },
  {
    ...
    description:
      "Khám phá ứng dụng Web3, nội dung và trải nghiệm số trong phạm vi an toàn, phù hợp và có trách nhiệm.",
  ...
  },
  {
    ...
    description:
      "Phát triển năng lực nghiên cứu, hạ tầng, an toàn thông tin và định hướng kiến trúc chung.",
    services: [
      "An toàn thông tin",
...
export const STRATEGY_AT_A_GLANCE = [
  ...
  },
  {
    ...
    label: "mảng năng lực",
    description:
      "Được đặt trong cùng một mô hình điều phối định hướng của AXVN Group.",
    icon: Building2,
  },
  {
    ...
    description:
      "Là khung đọc nội dung, không phải chỉ số đánh giá hiệu quả hay kết quả thực hiện.",
    icon: ShieldCheck,
  },
] as const;
