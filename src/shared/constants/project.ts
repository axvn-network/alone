...
export const PROJECT_TIMELINE: TimelinePhase[] = [
  {
    ...
    detail:
      "NQ 05/2025/NQ-CP: Chính phủ chính thức mở thị trường tài sản mã hóa hợp pháp đầu tiên tại Việt Nam",
    status: "done",
    date: "09/09/2025",
  },
  {
    ...
    detail:
      "QĐ 96/QĐ-BTC — điều kiện cấp phép chính thức, bắt đầu tiếp nhận hồ sơ xin cấp phép",
    status: "done",
    date: "20/01/2026",
  },
  {
    ...
    detail:
      "Tích lũy vốn, kết nạp cổ đông chiến lược, hoàn thiện đội ngũ và cơ cấu quản trị",
    status: "active",
  ...
  },
  {
    ...
    detail:
      "Hệ thống CNTT cấp độ 4, 10 quy trình nghiệp vụ chuẩn hóa, thẩm định Bộ Công An",
    status: "pending",
    date: "Q2–Q3 2026",
  },
  {
    ...
    detail:
      "Một bộ hồ sơ đầy đủ đúng quy định lên Bộ Tài chính — minh bạch và tuân thủ tuyệt đối",
    status: "pending",
    date: "Q4 2026",
  },
  {
    ...
    detail:
      "30 ngày thẩm định → hoạt động ngay. Sàn giao dịch tài sản mã hóa hợp pháp đầu tiên tại Việt Nam",
    status: "pending",
    date: "2026–2027",
  },
];
