/**
 * src/lib/vn/hanh-chinh.ts
 *
 * Danh sách mã đơn vị hành chính Việt Nam — CONFIG-DRIVEN.
 *
 * ⚠️  CẦN CẬP NHẬT KHI:
 *   - Nhà nước thực hiện sáp nhập tỉnh/thành (dự kiến từ 63 → 34 đơn vị)
 *   - Thay đổi mã tỉnh theo Nghị quyết UBTVQH
 *   - Nguồn cập nhật chính thống: https://dmhc.gov.vn hoặc
 *     https://thuvienphapluat.vn/van-ban/Bat-dong-san/Quyet-dinh-124-2004-QD-TTg
 *
 * Để cập nhật: chỉnh sửa file này HOẶC chạy script scripts/update-hanh-chinh.ts
 * Không hardcode mã tỉnh trong bất kỳ logic validate nào khác.
 *
 * Phiên bản dữ liệu: 2026-08-10 (63 tỉnh/thành hiện hành)
 * TODO: Cập nhật sau khi có Nghị quyết sáp nhập chính thức → còn 34 tỉnh
 */
 ...
 *
 * TODO: Cập nhật khi sáp nhập tỉnh thành chính thức có hiệu lực.
 */
